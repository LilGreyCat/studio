...
ALTER SEQUENCE artists_id_seq AS BIGINT NO MAXVALUE;
ALTER SEQUENCE projects_id_seq AS BIGINT NO MAXVALUE;
ALTER SEQUENCE admin_users_id_seq AS BIGINT NO MAXVALUE;
